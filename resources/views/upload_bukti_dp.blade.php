        ...
        <tbody>
            <tr>
                ...
                <td class="text-center">
                    <a href="" class="badge bg-success" style="text-decoration:none"type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Upload Pembayaran</a>
